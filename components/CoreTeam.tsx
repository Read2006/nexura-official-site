      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
            Meet the <span className="text-primary neon-text">Core Team</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Our core team members bringing specialized expertise and strategic leadership to drive innovation across continents.
          </p>
        </motion.div>
                ...
                <CardContent className="p-7 text-center flex flex-col items-center">
                  ...
                  >
                    <div className="rounded-full bg-background p-[2px]">
                      <CoreTeamAvatar src={member.image} alt={member.name} />
                    </div>
                    {/* ring highlight */}
...
function CoreTeamAvatar({ src, alt }: AvatarProps) {
